...
export function IconWorkbenchHistoryDrawer({
  ...
  return (
    <>
      <div className="fixed inset-0 z-[68] bg-black/20 backdrop-blur-[2px]" onClick={onClose} />
      <aside className="fixed right-0 top-0 z-[76] flex h-full w-full max-w-[520px] flex-col border-l-2 border-on-surface/12 bg-surface-container-lowest shadow-2xl">
