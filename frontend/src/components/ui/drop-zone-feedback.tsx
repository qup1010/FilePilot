...
export function DropZoneOverlay({
  ...
  return (
    <div
      className={cn(
        "absolute inset-2 z-50 flex items-center justify-center rounded-[10px] bg-primary/[0.035] backdrop-blur-[2px] pointer-events-none animate-in fade-in duration-200 overflow-hidden",
        className,
      )}
    >
      {/* 极富科技感的蓝紫色径向微光发光背景 */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(59,130,246,0.12)_0%,rgba(139,92,246,0.02)_60%,transparent_90%)] pointer-events-none animate-pulse" style={{ animationDuration: '4s' }} />
      ...
      <div className={cn("flex flex-col items-center justify-center gap-2 text-center relative z-10", panelClassName)}>
        <div className={cn("flex h-12 w-12 items-center justify-center rounded-[12px] bg-primary/12 text-primary shadow-[0_0_12px_rgba(59,130,246,0.15)]", iconWrapClassName)}>
