  ...
  return (
    <div className="mx-auto max-w-[1360px] space-y-5 py-5">
      <section className="overflow-hidden rounded-[12px] border border-on-surface/8 bg-surface-container-lowest shadow-[0_18px_44px_rgba(0,0,0,0.04)]">
        <div className="border-b border-on-surface/8 bg-surface px-5 py-4 lg:px-6">
      ...
      {(hasErrors || hasWarnings || reviewCount > 0) ? (
        <section className="space-y-3 rounded-[12px] border border-on-surface/8 bg-surface px-5 py-5 shadow-[0_10px_28px_rgba(0,0,0,0.03)]">
      ...
      <section className="rounded-[12px] border border-primary/12 bg-primary/6 p-5 shadow-[0_18px_44px_rgba(0,0,0,0.04)]">
